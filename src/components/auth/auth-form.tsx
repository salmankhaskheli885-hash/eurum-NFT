...
export async function handleGoogleSignIn(auth: Auth | null, firestore: Firestore | null, role: 'user' | 'partner', router: any, toast: any) {
  if (!auth || !firestore) {
  ...
  // This is a workaround for Firebase Studio environments.
  auth.tenantId = GoogleAuthProvider.providerId;
...
export function AuthForm({
  ...
  const onGoogleSignIn = () => {
    handleGoogleSignIn(auth, firestore, role, router, toast);
  };
